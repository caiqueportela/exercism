...
public class SecurityPassMaker
{
    public string GetDisplayName(TeamSupport support)
    {
        ...
        {
            Security security when !(security.GetType() == typeof(SecurityJunior) ||
                                     security.GetType() == typeof(SecurityIntern) ||
                                     security.GetType() == typeof(PoliceLiaison)) =>
                $"{security.Title} Priority Personnel",
